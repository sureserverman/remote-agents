...
project list, skipping the area choice, because `NAME` was lumped into `_TEXT_STEPS`; Back at
the review used to jump straight to the area list, skipping the name. On a real stack each is
