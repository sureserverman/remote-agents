...
> section is deliberately unfilled: it can only be performed against the real Telegram client,
> and recording an outcome nobody observed would make this file worthless for the one purpose it
> has. Fill it in during the run, or delete it.
